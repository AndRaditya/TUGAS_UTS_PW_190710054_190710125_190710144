...
<div class="container p-3 m-4 h-100" style="background-color: #FFFFFF; border-top: 5px solid #D65106; box-shadow:
    ...
    <form action="../process/editPesananProcess.php?id=<?php echo $dataPesanan['id_pesanan'];?>" method="post">
        ...
        <div class="mb-3">
            ...
            <div class="input-group has-validation">
                <input type="text" class="form-control" id="validationKeteranganMakanan"
                    name="validationKeteranganMakanan" placeholder="Contoh: Tidak pedas. Tidak ada keterangan = -"
        ...
        <div class="mb-3">
            ...
            <div class="input-group has-validation">
                <input type="text" class="form-control" id="validationKeteranganMinuman"
                    name="validationKeteranganMinuman" placeholder="Contoh: Tidak pakai es. Tidak ada keterangan = -"
                    aria-describedby="inputGroupPrepend"
